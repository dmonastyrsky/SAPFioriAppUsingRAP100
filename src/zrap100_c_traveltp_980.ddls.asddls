...
@EndUserText: {
  label: '##GENERATED Travel App (980)'
}
@ObjectModel: {
  sapObjectNodeType.name: 'ZRAP100_ATRAV980'
}
@AccessControl.authorizationCheck: #MANDATORY
@Search.searchable: true
define root view entity ZRAP100_C_TRAVELTP_980
  provider contract transactional_query
  as projection on ZRAP100_R_TRAVELTP_980
  association [1..1] to ZRAP100_R_TRAVELTP_980 as _BaseEntity on $projection.TravelID = _BaseEntity.TravelID
{
