CLASS zcl_rap100_gen_data_980 DEFINITION
PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS zcl_rap100_gen_data_980 IMPLEMENTATION.
...
*   clear data
    DELETE FROM zrap100_atrav980.
    DELETE FROM zrp100_atrv980_d.

    "insert travel demo data
    INSERT zrap100_atrav980  FROM (
        SELECT
